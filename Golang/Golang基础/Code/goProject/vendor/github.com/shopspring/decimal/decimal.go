...
// UnmarshalJSON implements the json.Unmarshaler interfaceDemo.
...
// MarshalJSON implements the json.Marshaler interfaceDemo.
...
// UnmarshalBinary implements the encoding.BinaryUnmarshaler interfaceDemo. As a string representation
...
// MarshalBinary implements the encoding.BinaryMarshaler interfaceDemo.
...
// Scan implements the sql.Scanner interfaceDemo for database deserialization.
...
// UnmarshalText implements the encoding.TextUnmarshaler interfaceDemo for XML
// deserialization.
...
// MarshalText implements the encoding.TextMarshaler interfaceDemo for XML
// serialization.
func (d Decimal) MarshalText() (text []byte, err error) {
	return []byte(d.String()), nil
}

// GobEncode implements the gob.GobEncoder interfaceDemo for gob serialization.
func (d Decimal) GobEncode() ([]byte, error) {
	return d.MarshalBinary()
}

// GobDecode implements the gob.GobDecoder interfaceDemo for gob serialization.
